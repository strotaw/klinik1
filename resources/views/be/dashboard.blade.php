                ...
                <div class="card-body">
                  ...
                  <div class="chat-box scrollable" style="height: 475px">
                    ...
                    <ul class="chat-list">
                      ...
                      <li class="chat-item">
                        <div class="chat-img">
                          <img src="{{asset('be/assets/images/users/1.jpg')}}" alt="user" />
                        </div>
                      ...
                      <li class="chat-item">
                        <div class="chat-img">
                          <img src="{{asset('be/assets/images/users/2.jpg')}}" alt="user" />
                        </div>
                        <div class="chat-content">
                      ...
                      <li class="chat-item">
                        <div class="chat-img">
                          <img src="{{asset('be/assets/images/users/3.jpg')}}" alt="user" />
                        </div>
                        <div class="chat-content">
