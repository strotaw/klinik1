              ...
              <div class="swiper-container team-slider-container" data-aos="fade-up" data-aos-duration="1300">
                <div class="swiper-wrapper team-slider">
                  ...
                  <div class="swiper-slide team-member">
                    <div class="thumb">
                      <img src="{{asset('fe/assets/img/team/01.jpg')}}" alt="Mexi-HasTech">
                    </div>
                    <div class="content">
                  ...
                  <div class="swiper-slide team-member">
                    <div class="thumb">
                      <img src="{{asset('fe/assets/img/team/02.jpg')}}" alt="Mexi-HasTech">
                    </div>
                    <div class="content">
                      <div class="member-info">
                  ...
                  <div class="swiper-slide team-member">
                    <div class="thumb">
                      <img src="{{asset('fe/assets/img/team/03.jpg')}}" alt="Mexi-HasTech">
                    </div>
                    <div class="content">
                      <div class="member-info">
