              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="gallery-item mb-30">
                    <div class="thumb">
                      <a class="lightbox-image" data-fancybox="gallery" href="{{asset('fe/assets/img/about/01.jpg')}}">
                        <img src="{{asset('fe/assets/img/about/01.jpg')}}" alt="Image">
                      </a>
                ...
                <div class="col-md-6">
                  <div class="gallery-item mb-30">
                    <div class="thumb">
                      <a class="lightbox-image" data-fancybox="gallery" href="{{asset('fe/assets/img/about/02.jpg')}}">
                        <img src="{{asset('fe/assets/img/about/02.jpg')}}" alt="Image">
                      </a>
                      <div class="overlay"><i class="icofont-plus"></i></div>
                    </div>
                  </div>
                ...
                <div class="col-md-12">
                  <div class="gallery-item">
                    <div class="thumb">
                      <a class="lightbox-image" data-fancybox="gallery" href="{{asset('fe/assets/img/about/03.jpg')}}">
                        <img src="{{asset('fe/assets/img/about/03.jpg')}}" alt="Image">
                      </a>
                      <div class="overlay"><i class="icofont-plus"></i></div>
                    </div>
                  </div>
