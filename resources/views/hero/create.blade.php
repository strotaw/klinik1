            ...
            <div class="col-12">
              <div class="card bg-warning">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="judul1" name="judul1" placeholder="Judul 1" required />
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="judul2" class="col-sm-2 col-form-label">Judul 2</label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="judul2" name="judul2" placeholder="Judul 2" required />
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="judul3" class="col-sm-2 col-form-label">Judul 3</label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="judul3" name="judul3" placeholder="Judul 3" required />
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="url_img" class="col-sm-2 col-form-label">Gambar</label>
                    <div class="col-sm-6">
                      <input type="file" class="form-control" id="url_img" name="url_img" placeholder="Gambar" required />
                    </div>
                </div>
                <div class="mb-3 row">
